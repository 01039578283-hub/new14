...
<html lang="ko"><head>
  ...
  <meta property="og:type" content="article"><meta property="og:locale" content="ko_KR"><meta property="og:title" content="{esc(title)} | {SITE_NAME}"><meta property="og:description" content="{esc(meta)}"><meta property="og:image" content="{rep_url}"><meta property="og:image:secure_url" content="{rep_url}"><meta property="og:image:type" content="{rep_mime}"><meta property="og:image:width" content="{rep_width}"><meta property="og:image:height" content="{rep_height}"><meta property="og:image:alt" content="{esc(title)} 대표 이미지">
  <meta name="twitter:card" content="summary"><meta name="twitter:title" content="{esc(title)} | {SITE_NAME}"><meta name="twitter:description" content="{esc(meta)}"><meta name="twitter:image" content="{rep_url}"><meta name="twitter:image:alt" content="{esc(title)} 대표 이미지">
...
def render_category_hub(records: list[dict]) -> str:
    ...
    hub_url = canonical_url()
    hub_title = f"{CATEGORY_NAME} 지역 안내 | {SITE_NAME}"
